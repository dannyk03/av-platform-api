...
export class migration1654504768464 implements MigrationInterface {
  name = 'migration1654504768464';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "loggers" (
                ...
                CONSTRAINT "pk_loggers__id" PRIMARY KEY ("id")
            )
        `);
    await queryRunner.query(`
            CREATE TABLE "users" (
    ...
    await queryRunner.query(`
            CREATE TABLE "permissions" (
                ...
                CONSTRAINT "pk_permissions__id" PRIMARY KEY ("id")
            )
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            CREATE TABLE "authapis" (
                ...
                CONSTRAINT "pk_authapis__id" PRIMARY KEY ("id")
            )
        `);
  }
