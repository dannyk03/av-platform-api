...
export class migration1654504398434 implements MigrationInterface {
  name = 'migration1654504398434';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "authapis" (
                ...
                CONSTRAINT "pk_authapis__id" PRIMARY KEY ("_id")
            )
        `);
    await queryRunner.query(`
            CREATE TABLE "users" (
    ...
    await queryRunner.query(`
            CREATE TABLE "permissions" (
                ...
                CONSTRAINT "pk_permissions__id" PRIMARY KEY ("_id")
            )
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            CREATE TABLE "roles" (
                ...
                CONSTRAINT "pk_roles__id" PRIMARY KEY ("_id")
            )
        `);
    await queryRunner.query(`
