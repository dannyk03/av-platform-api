...
export class migration1670551760094 implements MigrationInterface {
  name = 'migration1670551760094';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE "group_invite_member_links" (
                ...
                CONSTRAINT "chk_group_invite_member_link_invitee_not_inviter" CHECK (invitee_user_id != inviter_user_id),
                CONSTRAINT "chk_group_invite_member_links_temp_email_or_user_invitee_id" CHECK (
                    temp_email IS NOT NULL
