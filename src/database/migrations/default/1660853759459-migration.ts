...
export class migration1660853759459 implements MigrationInterface {
  name = 'migration1660853759459';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            CREATE TABLE "social_connections" (
                ...
                CONSTRAINT "uq_addressed_addressee_social_connection" UNIQUE ("addressed_user_id", "addressee_user_id"),
    ...
    await queryRunner.query(`
            CREATE TABLE "social_connection_request_blocks" (
                ...
                CONSTRAINT "uq_blocking_blocked_social_connection_request" UNIQUE ("blocking_user_id", "blocked_user_id"),
    ...
    await queryRunner.query(`
            ...
            ADD CONSTRAINT "fk_social_connections_addressed_user_id" FOREIGN KEY ("addressed_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
            ALTER TABLE "social_connections"
            ADD CONSTRAINT "fk_social_connections_addressee_user_id" FOREIGN KEY ("addressee_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "social_connections" DROP CONSTRAINT "fk_social_connections_addressee_user_id"
        `);
    await queryRunner.query(`
            ALTER TABLE "social_connections" DROP CONSTRAINT "fk_social_connections_addressed_user_id"
        `);
    await queryRunner.query(`
