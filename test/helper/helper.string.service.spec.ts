...
describe('HelperStringService', () => {
  ...
  describe('randomReference', () => {
    ...
    it('should be success', async () => {
      ...
      expect(helperStringService.randomReference(10, 'test')).toBe(result);
    });
  });
  ...
  describe('random', () => {
    ...
    it('should be success with options prefix', async () => {
      ...
      expect(helperStringService.random(5, { prefix: 'aaa' })).toBe(result);
    });
    ...
    it('should be success with options prefix and safe', async () => {
      ...
      expect(helperStringService.random(5, { prefix: 'aaa', safe: true })).toBe(
        result,
      );
    });
  });
  ...
  describe('censor', () => {
    ...
    it('string length > 10 should be success', async () => {
      const result = helperStringService.censor('12312312312312312312312');
      jest
        .spyOn(helperStringService, 'censor')
        .mockImplementation(() => result);
  ...
  describe('checkStringOrNumber', () => {
    ...
    it('should be success', async () => {
      ...
      jest
        .spyOn(helperStringService, 'checkStringOrNumber')
        .mockImplementation(() => result);
  ...
  describe('convertStringToNumberOrBooleanIfPossible', () => {
    ...
    it('should be success string', async () => {
      const result =
        helperStringService.convertStringToNumberOrBooleanIfPossible('check');
      jest
        .spyOn(helperStringService, 'convertStringToNumberOrBooleanIfPossible')
        .mockImplementation(() => result);
    ...
    it('should be success boolean', async () => {
      const result =
        helperStringService.convertStringToNumberOrBooleanIfPossible('true');
      jest
        .spyOn(helperStringService, 'convertStringToNumberOrBooleanIfPossible')
        .mockImplementation(() => result);
  ...
  describe('checkPasswordWeak', () => {
    ...
    it('should be success', async () => {
      const result = helperStringService.checkPasswordWeak('aaAAbbBBccCC');
      jest
        .spyOn(helperStringService, 'checkPasswordWeak')
        .mockImplementation(() => result);
  ...
  describe('checkPasswordMedium', () => {
    ...
    it('should be success', async () => {
      ...
      jest
        .spyOn(helperStringService, 'checkPasswordMedium')
        .mockImplementation(() => result);

      expect(helperStringService.checkPasswordMedium('aaAA12345')).toBe(result);
    });
  });
  ...
  describe('checkPasswordStrong', () => {
    ...
    it('should be success', async () => {
      const result = helperStringService.checkPasswordStrong('aaAA12345@!');
      jest
        .spyOn(helperStringService, 'checkPasswordStrong')
        .mockImplementation(() => result);
  ...
  describe('checkSafeString', () => {
    ...
    it('should be success', async () => {
      ...
      jest
        .spyOn(helperStringService, 'checkSafeString')
        .mockImplementation(() => result);
